...
var sqlite3InitModule = (() => {
  ...
  return function (sqlite3InitModule) {
    ...
    var SYSCALLS = {
      ...
      doStat: function (func, path, buf) {
        ...
        HEAP64[(buf + 56) >> 3] = BigInt(
          Math.floor(stat.atime.getTime() / 1000)
        );
        HEAP32[(buf + 64) >> 2] = 0;
    ...
    function convertJsFunctionToWasm(func, sig) {
      ...
      var bytes = [0x00, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00, 0x01];
    ...
    Module.postRun.push(function (Module) {
      ...
      self.WhWasmUtilInstaller = function (target) {
        ...
        target.getMemValue = function (ptr, type = "i8") {
          ...
          switch (type) {
            case "i1":
            case "i8":
              return c.HEAP8[ptr >> 0];
            case "i16":
              return c.HEAP16[ptr >> 1];
            case "i32":
              return c.HEAP32[ptr >> 2];
            case "i64":
              if (target.bigIntEnabled) return BigInt(c.HEAP64[ptr >> 3]);
              break;
            case "float":
            case "f32":
              return c.HEAP32F[ptr >> 2];
            case "double":
            case "f64":
              return Number(c.HEAP64F[ptr >> 3]);
            default:
              break;
          }
        ...
        target.setMemValue = function f(ptr, value, type = "i8") {
          ...
          switch (type) {
            ...
            case "i8":
              ...
              return f;
            case "i16":
              c.HEAP16[ptr >> 1] = value;
              return f;
            case "i32":
              c.HEAP32[ptr >> 2] = value;
              return f;
            case "i64":
              if (c.HEAP64) {
            ...
            case "float":
            case "f32":
              c.HEAP32F[ptr >> 2] = value;
              return f;
            case "double":
            case "f64":
              c.HEAP64F[ptr >> 3] = value;
              return f;
          }
        ...
        target.setPtrValue = (ptr, value) =>
          target.setMemValue(ptr, value, ptrIR);
        ...
        xcv.result["string:free"] = xcv.result["utf8:free"] = (i) => {
          try {
            return i ? target.cstringToJs(i) : null;
          } finally {
            target.dealloc(i);
          }
        };
        ...
        xcv.result["json:free"] = (i) => {
          try {
            return i ? JSON.parse(target.cstringToJs(i)) : null;
          } finally {
            target.dealloc(i);
          }
        };
        ...
        const __xArgAdapterCheck = (t) =>
          xcv.arg[t] || toss("Argument adapter not found:", t);

        const __xResultAdapterCheck = (t) =>
          xcv.result[t] || toss("Result adapter not found:", t);
        ...
        target.xWrap = function (fname, resultType, ...argTypes) {
          ...
          return function (...args) {
            ...
            try {
              const rc = xf.apply(
                null,
                args.map((v, i) => cache.xWrap.convertArg(argTypes[i], v))
              );
      ...
      self.Jaccwabyt = function StructBinderFactory(config) {
        ...
        const __memberSignature = function f(
          ...
          if (!f._)
            f._ = (x) => x.replace(/[^vipPsjrd]/g, "").replace(/[pPs]/g, "i");
        ...
        const __structMemberKeys = rop(function () {
          const a = [];
          Object.keys(this.structInfo.members).forEach((k) =>
          ...
          if (descr.readOnly) {
            ...
            prop.set = function (v) {
              ...
              new DataView(heap().buffer, this.pointer + descr.offset, sizeOf)[
                f._.setters[sigGlyph]
              ](0, f._.sw[sigGlyph](v), isLittleEndian);
            };
          }
            ...
            resolveToInstance: rop(function (v, throwIfNot = false) {
              if (!(v instanceof StructCtor)) {
                v = Number.isSafeInteger(v)
                  ? StructCtor.instanceForPointer(v)
                  : undefined;
              }
              if (!v && throwIfNot)
                toss("Value is-not-a", StructCtor.structName);
              return v;
            }),
      ...
      self.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
...

        {
          ...
          wasm.xWrap.argAdapter("flexible-string", (v) =>
        ...
        if (1) {
          ...
          wasm.xWrap.argAdapter("sqlite3*", aPtr)("sqlite3_stmt*", aPtr)(
            "sqlite3_context*",
            aPtr
          )("sqlite3_value*", aPtr)("sqlite3_vfs*", aPtr)("void*", aPtr);
          wasm.xWrap.resultAdapter("sqlite3*", aPtr)("sqlite3_context*", aPtr)(
            "sqlite3_stmt*",
            aPtr
          )("sqlite3_vfs*", aPtr)("void*", aPtr);
            ...
            const cbwrap = function (pVoid, nCols, pColVals, pColNames) {
              ...
              try {
                ...
                for (; i < nCols; offset += wasm.ptrSizeof * ++i) {
                  aVals.push(
                    wasm.cstringToJs(wasm.getPtrValue(pColVals + offset))
                  );
                  aNames.push(
                    wasm.cstringToJs(wasm.getPtrValue(pColNames + offset))
                  );
                }
        ...
        if (1) {
          ...
          const __xFunc = function (callback) {
            return function (pCtx, argc, pArgv) {
              try {
                __udfSetResult(
                  pCtx,
                  callback(pCtx, ...__udfConvertArgs(argc, pArgv))
                );
              } catch (e) {
          ...
          const __xFinalAndValue = function (callback) {
            return function (pCtx) {
              try {
                __udfSetResult(pCtx, callback(pCtx));
              } catch (e) {
                __udfSetError(pCtx, e);
              }
            };
        ...
        if (pKvvfs) {
          if (util.isUIThread()) {
            ...
            const kvvfsStorage = (zClass) =>
              115 === wasm.getMemValue(zClass) ? sessionStorage : localStorage;
        ...
        const installOpfsVfs = function callee(options) {
          ...
          const thePromise = new Promise(function (
            ...
            const installMethod = function callee(tgt, name, func) {
              ...
              if (sigN.length < 2) {
                toss(
                  "Member",
                  name,
                  " is not a function pointer. Signature =",
                  sigN
                );
              }
              const memKey = tgt.memberKey(name);
              const fProxy = 0 ? callee.argcProxy(func, sigN) : func;
            ...
            if (sqlite3.oo1) {
              ...
              opfsUtil.OpfsDb.prototype = Object.create(
                sqlite3.oo1.DB.prototype
              );
              sqlite3.oo1.DB.dbCtorHelper.setVfsPostOpenSql(
                opfsVfs.pointer,
                ["pragma journal_mode=truncate;"].join("")
              );
            }
                ...
                case "opfs-async-inited": {
                  try {
                    ...
                    if (opfsVfs.pointer !== capi.sqlite3_vfs_find("opfs")) {
                      toss(
                        "BUG: sqlite3_vfs_find() failed for just-installed OPFS VFS"
                      );
                    }
                    capi.sqlite3_vfs_register.addReference(
                      opfsVfs,
                      opfsIoMethods
                    );
